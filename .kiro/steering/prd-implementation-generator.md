---
description: PRD Implementation Plan Generator Rules
inclusion: manual
---
...
### File Organization
You must create and organize documentation in the `.kiro/specs/[feature-name]/` folder with the following structure:
```
